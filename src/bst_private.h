...
static void upo_bst_destroy_node(upo_bst_node_t *node, int destroy_data);

static void *upo_bst_get_impl(upo_bst_node_t *node, const void *key, upo_bst_comparator_t cmp);

static void *upo_bst_put_impl(upo_bst_node_t *node, void *key, void *value, void *old_value, upo_bst_comparator_t cmp);

static void *upo_bst_insert_impl(upo_bst_node_t *node, void *key, void *value, upo_bst_comparator_t cmp);

static void *upo_bst_delete_impl(upo_bst_node_t *node, const void *ke, int destroy_datay, upo_bst_comparator_t cmp);

static void *upo_bst_delete_1c_impl(upo_bst_node_t *node, int destroy_data);
...
static int upo_bst_is_leaf_impl(const upo_bst_node_t *node);
